...
// Council data-access + business logic.
...
export async function list(): Promise<unknown[]> {
  throw ApiError.internal("councils.service.list not yet implemented");
}

export async function getById(id: string): Promise<unknown> {
  throw ApiError.internal("councils.service.getById not yet implemented");
}

export async function create(data: unknown): Promise<unknown> {
  throw ApiError.internal("councils.service.create not yet implemented");
}

export async function update(id: string, data: unknown): Promise<unknown> {
  throw ApiError.internal("councils.service.update not yet implemented");
}
